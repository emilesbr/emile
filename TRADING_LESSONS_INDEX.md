...
La source #12 indique que le passage au breakeven devrait intervenir à la Confirmation (UT+2), pas à la Validation comme approximé dans `PHASE2_MONEYMANAGEMENT.md`. Si le backtest est retravaillé, corriger ce point.
