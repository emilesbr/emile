...
from emile.backtests.backtest_phase2 import FEE, EMA_SLOW  # lecture seule, aucune modification
from emile.backtests.backtest_phase2_v7 import prepare, LOCAL_DURATION, CONTEXT_DURATION, MIN_BORDERS  # idem
...
def load_volume(symbol: str) -> pd.DataFrame:
    ...
    from emile.backtests.backtest_phase2 import DATA_DIR
