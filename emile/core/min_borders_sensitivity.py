...
Note : `trend_table.py` fait `from emile.backtests.backtest_phase2_v7 import ... MIN_BORDERS`
...
from emile.backtests import backtest_phase2_v7
from emile.core import trend_table
from emile.backtests.backtest_phase2 import load_h1, resample, EMA_SLOW
from emile.backtests.backtest_phase2_v7 import run_v7, prepare, attach_higher_context, PROFILES_V4
from emile.core.trend_table import run_trend_table, load_volume, resample_volume, PROFILES_TREND
