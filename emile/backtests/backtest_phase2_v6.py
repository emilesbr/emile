...
def run_v6(df: pd.DataFrame, profile_name: str, use_regime_gate: bool = True) -> dict:
    ...
    def gate_extra(j):
        ...
        # Distinction réelle entrée fraîche / renfort (contrairement à
        # v7/ut2/capital_tiers) : le renfort exige EN PLUS pyramiding_allowed.
        return not_excess, (not_excess and pyramiding_allowed)
