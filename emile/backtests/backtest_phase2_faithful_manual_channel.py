...
from emile.backtests.backtest_phase2_v7 import prepare, PROFILES_V4, MAX_TRANCHES
...
from emile.core.manual_trend_channel import add_manual_trend_channel_columns, SWING_ORDER
