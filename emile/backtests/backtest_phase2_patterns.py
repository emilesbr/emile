...
from emile.backtests.backtest_phase2_v7 import prepare, PROFILES_V4, MIN_BORDERS, RULE3_STREAK, RULE3_SIZE_MULT, MAX_TRANCHES, EMA_SLOW
...
from emile.core.manual_trend_channel import add_manual_trend_channel_columns
