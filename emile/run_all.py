...
ENGINES: list[Engine] = [
    ...
    Engine("recommended", "emile.backtests.backtest_phase2_recommended",
           ...
           "phase2_recommended_results.csv"),
    Engine("unified", "emile.core.unified_protocol",
           ...
           "backtest_phase2_unified_results.csv"),
    Engine("faithful", "emile.backtests.backtest_phase2_faithful",
